...
<html>
<title>STOS : Edit Register Page</title>
<head>
<!-- Lib all css and  -->
			...
			<div class="mother-grid-inner">
				...
				<div style="padding-left: 250px; padding-top: 100px;">
					<nav aria-label="breadcrumb" style="width: 85%">
						<ol class="breadcrumb">
							<li><a href="javascript:void(0)"><i class="fa fa-floppy-o"
									aria-hidden="true"></i> Edit </a></li>
							<li class="breadcrumb-item active" aria-current="page">Edit Test
								case</li>
						</ol>
					</nav>
					<div class="col-sm-6">
						...
						<form:form name="form" role="form" method="POST" id="configForm"
							...
							<div>
								<div class="form-group">
									...
									<form:select path="tcVersion" class="form-control" 
										...
										<option value="${infoObj.tcVersion}" selected="selected">${infoObj.tcVersion}</option>
								...
								<div class="form-group">
									...
									<form:input path="tcName" class="form-control"
										id="tcVersion" placeholder="Enter Test Case Name"
										required="required" />
							...
							<button type="submit" id="submitButtonId" class="btn btn-primary">
								<i class="fa fa-floppy-o" aria-hidden="true"></i> Update Test
								Cases
							</button>
